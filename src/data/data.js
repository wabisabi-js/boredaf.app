export default [
  ...
  { activity: 'Try pat your head and rub your belly' },
  { activity: 'Code to create some awesome app.' },
  { activity: 'Learn programming 😃' },
  { activity: 'Take a walk' },
  { activity: 'Watch clouds pass by' },
  { activity: 'Eat some fish' },
  { activity: 'Sneak into the cinema' },
  { activity: 'Take a walk with your dog' },
  { activity: 'Read a few chapters of a book' },
  { activity: 'Fuck with a dog' },
  { activity: 'Read a book' },
  { activity: 'Skydiving' },
  { activity: 'Learn to bunnyhop' },
  { activity: 'Go drink' },
  { activity: 'Balance golf balls' },
  { activity: 'Create some cool IFTTT automations!' },
  {
    activity:
      'Call or message a friend you know you’ve hurt in the past and maybe make it up to them.'
  },
  { activity: 'Eat some Khinkali' },
  { activity: 'Build a boredaf.app' },
  { activity: 'Play League of Legends' },
  { activity: 'Play game' },
  { activity: 'Learn to solve a Rubiks Cube' },
  { activity: 'Bake a cake ' },
  { activity: 'Drop a Database' },
  { activity: 'Ride a unicycle in your swimming suit.' },
  { activity: 'Mediate for at least 5 5 minutes' },
  { activity: 'Testing code' },
  { activity: 'Draw' },
  { activity: 'Play paintball' },
  { activity: 'Have a nap' },
